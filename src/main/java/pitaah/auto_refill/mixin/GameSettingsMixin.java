...
public class GameSettingsMixin implements IAutoRefillModOptions {
	...
	@Unique public final OptionFloat refillSoundVolume = new OptionFloat(thisAs, "refillSoundVolume", .5f);
	...
	@Override
	public OptionFloat autoRefillSoundVolume() { return refillSoundVolume; }
}
