...
public abstract class BlockTrapDoorMixin
{
	@Inject(method = "onBlockPlaced", at = @At("HEAD"))
	public void OnBlockTrapDoorPlaced(World world, int x, int y, int z, Side side, EntityLiving entity, double sideHeight, CallbackInfo ci)
	{
